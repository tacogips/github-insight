...
/// List all project URLs registered in the current profile
///
/// Returns an array of project URLs for projects managed by the profile.
pub async fn list_project_urls_in_current_profile(
